#ifndef MAXWELL_KERNEL_H
#define MAXWELL_KERNEL_H

#include "salsa_kernel.h"

class MaxwellKernel : public KernelInterface
{
public:
    MaxwellKernel();
    ...
    virtual char get_identifier() { return 'm'; }
